      ...
      <div className='min-h-[80vh] grid md:grid-cols-2 max-w-6xl mx-auto'>
        ...
        <div className='w-[500px]'>
          <div className='flex flex-col justify-center items-center p-5 space-y-5 mt-14'>
            <h1 className='font-bold text-red-800 text-lg'>Your Cart Summary</h1>
            <p>
              <span className='text-gray-800 font-bold'>Total Item</span>
              <span className='text-gray-800 font-semibold'>: {state.length}</span>
            </p>
            <p>
       ...
       <div className='min-h-[80vh] flex flex-col items-center justify-center'>
        <h1 className='font-bold text-gray-800 text-xl mb-2'>Your Cart Is Empty</h1>
        <Link to={"/"}>
          <button  className='bg-red-950 text-white border-2 rounded-lg p-2'>SHOP NOW</button>
        </Link>
      </div>
      }
